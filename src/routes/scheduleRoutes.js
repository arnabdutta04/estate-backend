...
// Get all schedules for broker's properties (broker or admin only)
router.get('/broker-schedules', authorize('broker', 'admin'), scheduleController.getBrokerSchedules);

// Get a single schedule by ID
router.get('/:id', scheduleController.getScheduleById);

// Update schedule status (broker/admin can accept/reject)
router.patch('/:id/status', authorize('broker', 'admin'), scheduleController.updateScheduleStatus);
